...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallPinterest" Content="Pinterest" ToolTip="Pinterest is an image sharing and social media service designed to enable saving and discovery of information." Margin="0,0,2,0"/><TextBlock Name="WPFInstallPinterestLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://www.pinterest.com/" />
</StackPanel>
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallReNamer" Content="ReNamer" ToolTip="Pinterest is an image sharing and social media service designed to enable saving and discovery of information." Margin="0,0,2,0"/><TextBlock Name="WPFInstallReNamerLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://www.den4b.com/products/renamer" />
</StackPanel>
<StackPanel Orientation="Horizontal">
